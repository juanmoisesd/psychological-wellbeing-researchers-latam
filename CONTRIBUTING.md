# Contributing to Psychological Wellbeing of Researchers in Latin America

Thank you for your interest in contributing to **Psychological Wellbeing of Researchers in Latin America**!
...
Open an [Issue](https://github.com/juanmoisesd/psychological-wellbeing-researchers-latam/issues) describing:
...
```bibtex
@misc{delaserna_psychological_wellbeing_researchers_latam,
  author    = {de la Serna Tuya, Juan Moisés},
  title     = {Psychological Wellbeing of Researchers in Latin America},
  year      = {2024},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/psychological-wellbeing-researchers-latam},
...
*Questions? Contact via [GitHub Issues](https://github.com/juanmoisesd/psychological-wellbeing-researchers-latam/issues).*
